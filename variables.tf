...
variable "source_image_id" {
  type        = string
  description = "Source image for deployment (default: weka-custom-image-rocky8-1728382317). While other distributions may be compatible, only Rocky Linux 8.10 is officially tested with this Terraform module."
  default     = "projects/weka-dist/global/images/weka-custom-image-rocky8-1728382317"
}
