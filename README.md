...
| Name | Type |
|------|------|
| [google_artifact_registry_repository_iam_member.repo_appstream](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/artifact_registry_repository_iam_member) | resource |
| [google_artifact_registry_repository_iam_member.repo_baseos](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/artifact_registry_repository_iam_member) | resource |
...
| [google_cloud_run_v2_service.weka_api](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/cloud_run_v2_service) | resource |
...
| [google_cloudfunctions2_function.weka_api_function](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/cloudfunctions2_function) | resource |
...
| <a name="input_boot_disk_type"></a> [boot\_disk\_type](#input\_boot\_disk\_type) | The boot disk type. | `string` | `null` | no |
...
| <a name="input_containers_config_map"></a> [containers\_config\_map](#input\_containers\_config\_map) | Defines a mapping of WEKA processes, NICs, and memory specifications for machine types. | <pre>map(object({<br>    compute  = number<br>    drive    = number<br>    frontend = number<br>    nics     = number<br>    memory   = list(string)<br>  }))</pre> | <pre>{<br>  "c2-standard-16": {<br>    "compute": 4,<br>    "drive": 1,<br>    "frontend": 1,<br>    "memory": [<br>      "24.2GB",<br>      "23.2GB"<br>    ],<br>    "nics": 7<br>  },<br>  "c2-standard-8": {<br>    "compute": 1,<br>    "drive": 1,<br>    "frontend": 1,<br>    "memory": [<br>      "4.2GB",<br>      "4GB"<br>    ],<br>    "nics": 4<br>  },<br>  "n2-standard-16": {<br>    "compute": 4,<br>    "drive": 1,<br>    "frontend": 1,<br>    "memory": [<br>      "18.9GB",<br>      "18.9GB"<br>    ],<br>    "nics": 7<br>  },<br>  "n2-standard-8": {<br>    "compute": 1,<br>    "drive": 1,<br>    "frontend": 1,<br>    "memory": [<br>      "3.1GB",<br>      "1.6GB"<br>    ],<br>    "nics": 4<br>  },<br>  "z3-highmem-16-highlssd": {<br>    "compute": 3,<br>    "drive": 2,<br>    "frontend": 1,<br>    "memory": [<br>      "85GB",<br>      "85.3GB"<br>    ],<br>    "nics": 7<br>  },<br>  "z3-highmem-22-highlssd": {<br>    "compute": 4,<br>    "drive": 1,<br>    "frontend": 1,<br>    "memory": [<br>      "131.9GB",<br>      "132.2GB"<br>    ],<br>    "nics": 7<br>  },<br>  "z3-highmem-32-highlssd": {<br>    "compute": 3,<br>    "drive": 2,<br>    "frontend": 1,<br>    "memory": [<br>      "211.1GB",<br>      "211.4GB"<br>    ],<br>    "nics": 7<br>  },<br>  "z3-highmem-44-highlssd": {<br>    "compute": 3,<br>    "drive": 2,<br>    "frontend": 1,<br>    "memory": [<br>      "305.6GB",<br>      "305.9GB"<br>    ],<br>    "nics": 7<br>  },<br>  "z3-highmem-8-highlssd": {<br>    "compute": 1,<br>    "drive": 1,<br>    "frontend": 1,<br>    "memory": [<br>      "33.9GB",<br>      "34.2GB"<br>    ],<br>    "nics": 4<br>  },<br>  "z3-highmem-88-highlssd": {<br>    "compute": 3,<br>    "drive": 2,<br>    "frontend": 1,<br>    "memory": [<br>      "384GB",<br>      "384GB"<br>    ],<br>    "nics": 7<br>  }<br>}</pre> | no |
...
| <a name="input_nvmes_number"></a> [nvmes\_number](#input\_nvmes\_number) | Number of NVMe disks to attach to each host. | `number` | `null` | no |
...
| <a name="input_source_image_id"></a> [source\_image\_id](#input\_source\_image\_id) | Source image for deployment (default: rocky-linux-8-v20240910). While other distributions may be compatible, only Rocky Linux 8.10 is officially tested with this Terraform module. | `string` | `"rocky-linux-8-v20240910"` | no |
