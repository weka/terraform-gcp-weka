...
| <a name="input_data_services_instance_type"></a> [data\_services\_instance\_type](#input\_data\_services\_instance\_type) | The virtual machine type (SKU) for deploying data services instances. | `string` | `"n2-standard-4"` | no |
