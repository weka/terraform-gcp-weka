...
| <a name="input_client_source_image_id"></a> [client\_source\_image\_id](#input\_client\_source\_image\_id) | Client Source image ID is set to Rocky 8.9. For the list of all supported Weka Client OSs please refer to: https://docs.weka.io/planning-and-installation/prerequisites-and-compatibility#operating-system | `string` | `"rocky-linux-8-v20240515"` | no |
...
| <a name="input_weka_version"></a> [weka\_version](#input\_weka\_version) | WEKA version | `string` | `"4.2.12.87"` | no |
