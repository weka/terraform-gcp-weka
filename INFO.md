...
This Terraform can use existing network (VPC/subnets etc.) or create new network.<br>
...
1. [**setup_network**](modules/setup_network): includes VPC, subnets, peering, firewall and health check.
