# Private VPC that creates worker pool and uses it
...
| <a name="input_worker_disk_size"></a> [worker\_disk\_size](#input\_worker\_disk\_size) | ize of the disk attached to the worker, in GB | `number` | n/a | yes |
